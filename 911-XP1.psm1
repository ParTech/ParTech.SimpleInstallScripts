...
Function Install-Sitecore911XP1 (
    ...
    [string] $SCInstallRoot = "C:\Downloads\9.1.1", # The root folder with the license file and WDP files.
    ...
    [string] $MachineLearningServerUrl = "", # The URL of the Machine Learning server
...
)
{
    Invoke-DownloadPackages $DownloadBase `
                      ...
                      "XP1 Configuration files 9.1.1 rev. 002459.zip"
    ...
    $XP1Parameters = @{
        ...
        XP1CollectionPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_xp1collection.scwdp.zip").FullName
        XP1CollectionSearchPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_xp1collectionsearch.scwdp.zip").FullName
        XP1CortexProcessingPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_xp1cortexprocessing.scwdp.zip").FullName
        XP1MarketingAutomationPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_xp1marketingautomation.scwdp.zip").FullName
        XP1MarketingAutomationReportingPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_xp1marketingautomationreporting.scwdp.zip").FullName
        XP1ReferenceDataPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_xp1referencedata.scwdp.zip").FullName
        XP1CortexReportingPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_xp1cortexreporting.scwdp.zip").FullName
        SitecoreXP1CDPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. 002459 (OnPrem)_cd.scwdp.zip").FullName
        SitecoreXP1CMPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. 002459 (OnPrem)_cm.scwdp.zip").FullName
        SitecoreXP1RepPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_rep.scwdp.zip").FullName
        SitecoreXP1PrcPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_prc.scwdp.zip").FullName
        IdentityServerPackage = (Get-ChildItem "$SCInstallRoot\Sitecore.IdentityServer 2.0.1 rev. * (OnPrem)_identityserver.scwdp.zip").FullName
    ...
    Install-SitecoreWrapper "911-XP1" $XP1Parameters $SCInstallRoot -DoUninstall:$DoUninstall
}