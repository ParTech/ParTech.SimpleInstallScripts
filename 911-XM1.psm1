...
Function Install-Sitecore911XM1 (
    ...
    [string] $SitecoreContentManagementSitename = "$Prefix.cm.local", # The name for the Sitecore Content Management server.
...
)
{
    Invoke-DownloadPackages $DownloadBase `
                      ...
                      "XM1 Configuration files 9.1.1 rev. 002459.zip"
    ...
    $singleDeveloperParams = @{
        ...
        SiteCoreContentManagementPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (XM) (OnPrem)_cm.scwdp.zip").FullName
        SitecoreContentDeliveryPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (XM) (OnPrem)_cd.scwdp.zip").FullName
    ...
    Install-SitecoreWrapper "911-XM1" $singleDeveloperParams $SCInstallRoot -DoUninstall:$DoUninstall
}