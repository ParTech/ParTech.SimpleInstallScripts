...
Function Install-Sitecore911XP0 (
...
)
{
    Invoke-DownloadPackages $DownloadBase `
                      ...
                      "XP0 Configuration files 9.1.1 rev. 002459.zip"
    ...
    $singleDeveloperParams = @{
        ...
        XConnectPackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_xp0xconnect.scwdp.zip").FullName
        SitecorePackage = (Get-ChildItem "$SCInstallRoot\Sitecore 9.1.1 rev. * (OnPrem)_single.scwdp.zip").FullName
    ...
    Install-SitecoreWrapper "911-XP0" $singleDeveloperParams $SCInstallRoot -DoUninstall:$DoUninstall
}